...
transactions.route('/').post(async (req, res) => {
    const { total_price, paid_amount, products, kembalian,status_makanan, status_pembayaran } = req.body
	
    const order = {
        no_order: randomOrderNumber(), total_price, paid_amount, kembalian, status_makanan, status_pembayaran
    }
